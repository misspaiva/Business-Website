...
export function RecursoGratuito() {
      ...
      <div className="container-editorial">
        ...
        >
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-ink-muted text-pretty sm:text-lg">
            Documento gratuito. Sem pitch. Os riscos reais que times brasileiros estão
          ...
          {submitted ? (
            ...
            >
              <label htmlFor="recurso-email" className="sr-only">
                Seu e-mail
              </label>
              <input
                id="recurso-email"
              ...
              <p className="text-xs text-ink-faint">
                Sem spam. Apenas o documento e, se quiser depois, conteúdo sobre
